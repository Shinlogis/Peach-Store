					...
					<div class="card grade-card">
						...
						<div class="card-body">
							<table >
								<thead>
									<tr>
										<th style="padding-top: 15px; padding-bottom: 15px;">GOLD</th>
									</tr>
								</thead>
							</table>
						</div>
				...
				<div class="col-6">
					<div class="card review-card">
						<div class="review-header">
							...
							<a href="#" style="color: white;">상품리뷰 ></a></h5>
						</div>
						<div class="card-body">
							<table>
								<thead>
									<tr>
										<th style="padding-top: 15px; padding-bottom: 15px;">0개</th>
									</tr>
								</thead>
							</table>
						</div>
				...
				<div class="col-12">
					<div class="card table-card">
						<div class="card-header" style="display: flex; justify-content: space-between; ">
							<h3 class="card-title">최근 주문</h3> <a href="#" style="color: black;">더보기 ></a>
