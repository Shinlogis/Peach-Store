...
<%@ include file="../inc/header.jsp" %>
    ...
    <!-- 글 쓰기 시작 -->
			...
			<h3 style=" margin-bottom: 50px; font-weight:bold;">리뷰하기</h3>
				<!-- Main content -->
				<section class="content">
					...
					<div class="card">
						<div class="card-body">
							...
							<input type="hidden" name="orderDetail.order_detail_id" value="<%=orderDetail.getOrder_detail_id() %>">
								...
								<div class="form-group">
									<button type="button" class="btn btn-primary" id="bt_regist">리뷰 등록</button>
								</div>
							</form>
						</div>
					</div>
