...
<%
	int todayAmount = (int) request.getAttribute("todayAmount");
	int todayReceiptCount = (int) request.getAttribute("todayReceiptCount");
	int todayNewUserCount = (int) request.getAttribute("todayNewUserCount");
	int noAnsweredInquiryCount = (int) request.getAttribute("noAnsweredInquiryCount");
	List<String> salesDates = (List<String>) request.getAttribute("salesDates");
	List<Long> totalAmounts = (List<Long>) request.getAttribute("totalAmounts");
