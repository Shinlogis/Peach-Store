...
<body>
  ...
  <script>
    ...
    .then(res => {
      ...
      // 최종 성공 페이지로 이동
      window.location.href = "/admin/payment/success?orderId=" + orderId + "&amount=" + amount;
    })
    .catch(() => {
      // 실패 페이지로 이동
      window.location.href = "/admin/payment/fail?orderId=" + orderId + "&amount=" + amount + "&orderReceiptId=" + orderReceiptId;
    });
  </script>
</body>
</html>
