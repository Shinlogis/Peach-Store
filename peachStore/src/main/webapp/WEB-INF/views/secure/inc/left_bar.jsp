...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
	<!-- Brand Logo -->
	<a href="/static/admin/index3.html" class="brand-link"> <img
               ...
               with font-awesome or any other icon font library -->
				...
				<li class="nav-item menu-open"><a href="#" class="nav-link">
					...
					<ul class="nav nav-treeview">
						...
						<li class="nav-item"><a href="/admin/product/category/list"
							class="nav-link"> <i class="far fa-circle nav-icon"></i>
								<p>카테고리 관리</p>
						</a></li>
					</ul></li>
				...
				<li class="nav-item menu-open"><a href="#" class="nav-link">
					...
					<ul class="nav nav-treeview">
						<li class="nav-item"><a href="/admin/order/orderlist"
							class="nav-link"> <i class="far fa-circle nav-icon"></i>
								<p>주문내역</p>
						</a></li>
					</ul></li>
				...
				<li class="nav-item menu-open"><a href="#" class="nav-link">
						<i class="nav-icon fas fa-tachometer-alt"></i>
						<p>
							리뷰관리 <i class="right fas fa-angle-left"></i>
						</p>
				</a>
					<ul class="nav nav-treeview">
						<li class="nav-item"><a href="/admin/review/list"
							class="nav-link"> <i class="far fa-circle nav-icon"></i>
								<p>리뷰내역</p>
						</a></li>
					</ul></li>
				...
				<li class="nav-item menu-open"><a href="#" class="nav-link">
						...
						<p>
							관리자 관리 <i class="right fas fa-angle-left"></i>
						</p>
				</a>
					<ul class="nav nav-treeview">
						<li class="nav-item"><a href="/admin/user/adminlist"
							class="nav-link"> <i class="far fa-circle nav-icon"></i>
								<p>관리자목록</p>
						</a></li>
						<li class="nav-item"><a href="/admin/user/registform"
							class="nav-link"> <i class="far fa-circle nav-icon"></i>
								<p>관리자등록</p>
						</a></li>
						<li class="nav-item"><a href="/admin/user/changepasswordform"
							class="nav-link"> <i class="far fa-circle nav-icon"></i>
								<p>비밀번호변경</p>
						</a></li>
					</ul></li>
				...
				<li class="nav-item menu-open"><a href="#" class="nav-link">
					...
					<ul class="nav nav-treeview">
						<li class="nav-item"><a href="/admin/member/memberlist"
							class="nav-link"> <i class="far fa-circle nav-icon"></i>
								<p>회원목록</p>
						</a></li>
						<li class="nav-item"><a href="/admin/usergrade/list"
							class="nav-link"> <i class="far fa-circle nav-icon"></i>
								<p>멤버십 등급</p>
						</a></li>
					</ul></li>
				...
				<li class="nav-item menu-open"><a href="#" class="nav-link">
					...
					<ul class="nav nav-treeview">
						<li class="nav-item"><a href="/admin/inquiry/list"
							class="nav-link"> <i class="far fa-circle nav-icon"></i>
								<p>문의관리</p>
						</a></li>
					</ul></li>
